...
// Modul umumiy ko'rinishlarida ishlatiladigan chiziqli ikonkalar. Ilgari
// yetkazib berish sahifasi ichida turardi; ta'minot ko'rinishi ham shu
// to'plamdan foydalanadi.
...
function orderTracks(order = {}, related = {}) {
  ...
  const isStock = Boolean(related.allocations?.length);
