...
function bindInvoiceDocumentUpload(invoice) {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    if (field(form, "uploaded_by")) data.append("uploaded_by", field(form, "uploaded_by"));
